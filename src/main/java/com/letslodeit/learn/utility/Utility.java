package com.letslodeit.learn.utility;
...
public class Utility extends BasePage {
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/com/letslodeit/learn/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/letslodeit/learn/screenshots/" + screenshotName + dateName + ".png";
